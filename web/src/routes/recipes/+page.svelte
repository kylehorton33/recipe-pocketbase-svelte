...
{#if isSearchVisible}
    ...
    >
        <div
            ...
            class="hide-scrollbar relative mx-5 h-[400px] w-[500px] overflow-y-scroll rounded-md bg-white/20 outline outline-2 outline-white/40"
        >
            <div
            ...
            <div class="w-full p-3">
                ...
                {#each filteredRecipes as { name, slug, ingredients }}
                    ...
                    >
                        <div>
                            <h3 class="text-start">{name}: <small>{ingredients}</small></h3>
...
<div class="flex flex-col space-y-4 items-center">
    <button
        ...
        class="flex w-full md:w-96 items-center gap-2 rounded-md bg-none p-2 text-white/50 outline outline-[1.5px] outline-white/10 transition hover:bg-white/10"
    >
